    ...
    return (
      ...
      >
        <motion.input
          ...
          className={cn(
            "block w-full bg-transparent border-b py-2 text-text-primary placeholder-transparent focus:outline-none transition-all duration-300",
            "font-sans text-base",
            ...
            error 
              ...
              : success 
                ...
                : "border-forest-divider hover:border-accent/30",
            (isFocused || isHovered) && "bg-forest-800/20",
            className
          )}
